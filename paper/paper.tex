...
In scenario 1 the user server uses the same algorithm as the first client and the random server uses the same algorithm as the second client. Tests in this scenario cover behavioral differences between TCP congestion algorithms when a user owns a node in the network of a multitenant datacenter.
...
\subsubsection{Theoretical Algorithm Characteristics}
