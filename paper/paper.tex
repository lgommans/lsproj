...
TODO in the next section blah, then blah, and finally blah.
...
\subsection{Theoretical Algorithm Characteristics}
...
\begin{enumerate}
	...
	\item{The monitoring solution periodically checks if congestion and delay are not detected. If both are not detected, the traffic shaping policy is reversed again as more bandwidth is available to allocate to customers.}
\end{enumerate}

To do: Not sure about last enumerate item.
