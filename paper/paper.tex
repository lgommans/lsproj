...
\begin{figure}[H]
	\makebox[\textwidth]{
		...
		\begin{minipage}{0.5\paperwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{figs/bic_vs_cubic_8_0.png}
...
reaches 850$\pm$20 megabits per second. BBR is a delay based algorithm, so it mainly reacts based on delay. Other algorithms will reach much lower
